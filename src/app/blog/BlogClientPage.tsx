...
const getPostsByMonth = (posts: PostData[]) => {
...
export default function BlogClientPage({ allPostsData }: BlogClientPageProps) {
  const [searchTerm, setSearchTerm] = useState('');
  const [selectedMonth, setSelectedMonth] = useState<string | null>(null);

  const postsByMonth = useMemo(() => getPostsByMonth(allPostsData), [allPostsData]);
  ...
  const filteredPosts = useMemo(() => {
    ...
    return posts;
  }, [searchTerm, selectedMonth, allPostsData, postsByMonth]);
