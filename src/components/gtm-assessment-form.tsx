        ...
        <div className="mx-auto max-w-3xl">
          <Card className="shadow-2xl border-t-4 border-primary bg-white/50 backdrop-blur-sm">
            <CardHeader className="text-center">
              <CardTitle className="text-4xl font-headline text-primary">Get Your GTM Feasibility Assessment</CardTitle>
              <CardDescription className="pt-2 text-lg">
                Fill out the form below to receive a data-driven forecast of your GTM strategy's potential.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {isSuccess ? (
                <div className="text-center p-8 flex flex-col items-center gap-4 animate-in fade-in zoom-in-95 duration-500">
                  ...
                  <p className="text-muted-foreground text-lg">
                    Thank you! We will analyze your data and get back to you with your report within 24 hours.
                  </p>
                     ...
                     <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="e.g., Sharma Innovations" {...field} className="py-6 text-base" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="e.g., priya@example.com or +91 98765 43210" {...field} className="py-6 text-base" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                           ...
                           <FormDescription>
                            Please describe your main go-to-market challenge in a few words.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
